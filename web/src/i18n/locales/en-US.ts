export default {
    meta: {
        title: "Dagou Canvas",
        description: "A Dagou Canvas creation tool",
    },
    ...
    canvas: {
        defaultTitle: "Dagou Canvas {{count}}",
        ...
        export: { defaultProjectName: "Dagou Canvas", defaultNodesName: "Canvas elements", item: "Element" },
        createMenu: {
    ...
    home: {
        ...
        description: "Generate, connect, and reshape <content>images, text, and graphics</content> in <canvas>Dagou Canvas</canvas>, turning one-off generations into a continuous creative process.",
        start: "Get started",
    ...
    config: {
        ...
        localStorage: {
            ...
            description: "View browser data saved by Dagou Canvas, grouped by object store.",
            ...
            mainDatabase: "Dagou Canvas data",
