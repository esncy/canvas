export default {
    ...
    prompts: {
        title: "提示词库",
        library: "提示词库",
        total: "当前共 {{count}} 条提示词（外网访问权限体验更好）",
        category: "分类",
        tags: "标签",
        search: "搜索标题、内容或标签",
        searchTitle: "按标题查询",
    ...
    canvas: {
        ...
        export: { defaultProjectName: "大狗AI画布", defaultNodesName: "画布元素", item: "元素" },
        createMenu: {
    ...
    home: {
        promptError: "获取提示词失败",
        description: "在 <canvas>大狗AI画布</canvas> 中生成、连接和重组 <content>图片、文字与图形</content>，让创作从单次生成变成连续推演。",
        start: "开始使用",
        openCanvas: "打开画布",
        showcaseTitle: "用他人经验，干自己的活",
        showcaseDescription: "优秀的创作，从专业的经验开始。1000+提示词模板（外网访问权限体验更好）",
        viewPrompts: "查看提示词库",
    },
    version: {
        viewUpdates: "查看版本更新",
    ...
    config: {
        ...
        localStorage: {
            ...
            description: "查看大狗AI画布在浏览器中保存的数据量，并按对象仓库统计内容体积。",
    ...
    agent: {
        ...
        connect: { pluginTitle: "方式一：在 Codex 中使用插件", pluginText: "在 Codex app 安装大狗AI画布插件后，通过插件启动画布，插件会自动启动本地 Agent 并带上连接信息。", directTitle: "方式二：直接运行 Agent", directText: "不使用 Codex 插件时，在终端运行下面命令，再回到网页里连接或手动填入 Local URL 和 Connect token。", commandCopied: "命令已复制", pluginReminder: "Codex 插件提醒", pluginReminderText: "只有安装 Codex 插件或手动添加 MCP 后，工具列表才会进入 Codex 上下文并增加 token 消耗；仅运行 npx -y @esncy/canvas-agent 启动本地 Agent 不会安装 MCP。", removePlugin: "移除插件", removeMcp: "移除手动 MCP", copyCommand: "复制命令", title: "连接本地 Agent", description: "按使用场景选择一种连接方式。", webConnection: "网页连接", autoDiscover: "默认自动读取 Local URL 和 Connect token，失败时再手动填写。", disconnect: "断开", connect: "连接", localAddress: "本地地址", urlPlaceholder: "例如 http://127.0.0.1:17371", token: "连接 Token", tokenPlaceholder: "自动发现，或手动填入 Connect token" },
